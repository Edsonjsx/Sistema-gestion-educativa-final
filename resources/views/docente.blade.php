...
<div class="flex flex-col items-center justify-start min-h-screen bg-gray-100">
    <h1 class="text-center text-gray-800 text-2xl font-medium mt-8">Lista de Docentes</h1>
            ...
            <table class="w-full border border-gray-300 rounded-lg">
                ...
                <tbody>
                    ...
                    <tr class="text-center text-gray-600 border-t">
                        <td class="py-3 px-4">{{ $item->id_docente }}</td>
                        ...
                        <td class="py-3 px-4">{{ $item->curso->nombre }}</td>
                        <td class="py-3 px-4">{{ $item->estado }}</td>
                        <td class="py-3 px-4">
                            <form action="{{ route('docente.actualizar', $item->id_docente) }}" method="GET">
                        ...
                        <td class="py-3 px-4">
                            <form action="{{ route('docente.show', $item->id_docente) }}" method="GET">
    ...
    <p class="flex space-x-4">
        <a href="{{ route('docente.create')}}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-3 px-5 rounded">Agregar un Docente</a>
