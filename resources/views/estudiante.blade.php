...
<div class="flex flex-col items-center justify-start min-h-screen bg-gray-100">
    <h1 class="text-center text-gray-800 text-2xl font-medium mt-8">Lista de Estudiantes</h1>
            ...
            <table class="w-full border border-gray-300 rounded-lg">
                <thead>
                    <tr class="bg-gray-300 text-gray-700 uppercase text-sm leading-normal text-center">
                        ...
                        <th class="py-3 px-4">Apoderado</th>
                ...
                <tbody>
                    ...
                    <tr class="text-center text-gray-600 border-t">
                        <td class="py-3 px-4">{{ $item->id_estudiante }}</td>
                        ...
                        <td class="py-3 px-4">{{ $item->fecha_nacimiento }}</td>
                        <td class="py-3 px-4">{{ $item->apoderado->nombre }}</td>
                        <td class="py-3 px-4">{{ $item->grado->grado }}</td>
                        <td class="py-3 px-4">{{ $item->seccion->seccion }}</td>
                        <td class="py-3 px-4">{{ $item->estado }}</td>
                        <td class="py-3 px-4">
                            <form action="{{ route('estudiante.actualizar', $item->id_estudiante) }}" method="GET">
                        ...
                        <td class="py-3 px-4">
                            <form action="{{ route('estudiante.show', $item->id_estudiante) }}" method="GET">
    ...
    <p class="flex space-x-4">
        <a href="{{ route('estudiante.create')}}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-3 px-5 rounded">Agregar un Estudiante</a>
